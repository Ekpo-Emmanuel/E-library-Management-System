...
import { BookOpen, ArrowLeft, FileType, Calendar } from 'lucide-react'
import { getContentBorrowStatus } from '@/app/actions/borrow'
import { getContentAvailabilityStatus } from '@/app/actions/content'
...
export default async function ContentDetailPage({
  ...
  // Get the content borrow status
  const { status, userHasBorrowed, borrowId } = await getContentBorrowStatus(contentId)
  
  // Get availability status
  const { userHasReserved, reservationId, waitlistPosition, waitlistCount } = await getContentAvailabilityStatus(contentId)
          ...
          <Card>
            ...
            <CardFooter className="flex justify-center">
              <ContentBorrowStatus 
                ...
                userHasBorrowed={userHasBorrowed || false}
                borrowId={borrowId || null}
                userHasReserved={userHasReserved || false}
